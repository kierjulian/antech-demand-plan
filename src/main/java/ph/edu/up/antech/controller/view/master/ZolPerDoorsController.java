...
public class ZolPerDoorsController {
    ...
    public String updateZolPerDoors(RedirectAttributes redirectAttributes,
        ...
        try {
            ...
            redirectAttributes.addFlashAttribute("errorMessage", "An error occurred while updating ZOL Per Doors.");
    ...
    public String deleteZolPerDoors(RedirectAttributes redirectAttributes, @PathVariable Integer id) {
        try {
            ...
            redirectAttributes.addFlashAttribute("errorMessage", "An error occurred while deleting ZOL Per Doors.");
            LOGGER.error(e.getMessage(), e);
        }
