...
public class MdcPerBranchSalesAccountController {
    ...
    public String loadMdcPerBranchSalesAccountPage(Model model, @PageableDefault Pageable pageable,
        ...
        Page<MdcPerBranchSalesAccount> page = StringUtils.isNullOrEmpty(filter)
                ? mdcPerBranchSalesAccountService.findAll(pageable)
                : mdcPerBranchSalesAccountService.findAllByAnyColumnContaining(filter, pageable);
    ...
    public String updateMdcPerBranchSalesAccount(RedirectAttributes redirectAttributes,
        ...
        try {
            ...
            redirectAttributes.addFlashAttribute("errorMessage", "An error occurred while updating MDC Per Branch Sales Account.");
    ...
    public String createMdcPerBranchSalesAccount(RedirectAttributes redirectAttributes,
        ...
        try {
            ...
            redirectAttributes.addFlashAttribute("errorMessage", "An error occurred while saving MDC Per Branch Sales Account.");
            LOGGER.error(e.getMessage(), e);
    ...
    public String removeMdcPerBranchSalesAccount(
        ...
        try {
            ...
            redirectAttributes.addFlashAttribute("errorMessage", "An error occurred while deleting MDC Per Branch Sales Account.");
            LOGGER.error(e.getMessage(), e);
        }
